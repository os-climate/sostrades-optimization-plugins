...
from sostrades_optimization_plugins.sos_processes.test.test_sellar_opt_w_design_var_sub.usecase import (
...
class SellarOptimSubprocessJacobianDiscTest(AbstractJacobianUnittest):
    ...
    def _test_01_gradient_subprocess_double_level_coupling(self):
        ...
        builder = ee.factory.get_builder_from_process('sostrades_optimization_plugins.sos_processes.test',
