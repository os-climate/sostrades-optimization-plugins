...
class ProcessBuilder(BaseProcessBuilder):
    ...
    def get_builders(self):
        ...
        mod_func = 'sostrades_optimization_plugins.models.func_manager.func_manager_disc.FunctionManagerDisc'
        mod_dv = 'sostrades_optimization_plugins.models.design_var.design_var_disc.DesignVarDiscipline'
